glabel AudioOcarina_RecordStep
/* B64F08 800EDD68 27BDFFE0 */  addiu $sp, $sp, -0x20
/* B64F0C 800EDD6C AFBF0014 */  sw    $ra, 0x14($sp)
/* B64F10 800EDD70 3C1F8013 */  lui   $ra, %hi(sOcarinaRecordMode) # $ra, 0x8013
/* B64F14 800EDD74 27FF1858 */  addiu $ra, %lo(sOcarinaRecordMode) # addiu $ra, $ra, 0x1858
...
/* B64F28 800EDD88 3C028013 */   lui   $v0, %hi(sLastOcarinaBtnVal) # $v0, 0x8013
...
/* B64F4C 800EDDAC 24421864 */  addiu $v0, %lo(sLastOcarinaBtnVal) # addiu $v0, $v0, 0x1864
...
/* B64F60 800EDDC0 3C198013 */  lui   $t9, %hi(sOcarinaNoteStartT) # $t9, 0x8013
/* B64F64 800EDDC4 3C188017 */  lui   $t8, %hi(sOcarinaCurTime) # $t8, 0x8017
/* B64F68 800EDDC8 8F18BA04 */  lw    $t8, %lo(sOcarinaCurTime)($t8)
/* B64F6C 800EDDCC 8F391860 */  lw    $t9, %lo(sOcarinaNoteStartT)($t9)
/* B64F70 800EDDD0 91AE0000 */  lbu   $t6, ($t5)
/* B64F74 800EDDD4 3C038013 */  lui   $v1, %hi(sLastOcarinaVolume) # $v1, 0x8013
...
/* B64F8C 800EDDEC 24631868 */  addiu $v1, %lo(sLastOcarinaVolume) # addiu $v1, $v1, 0x1868
...
/* B64FA4 800EDE04 3C058013 */  lui   $a1, %hi(sLastOcarinaVibrato) # $a1, 0x8013
/* B64FA8 800EDE08 24A5186C */  addiu $a1, %lo(sLastOcarinaVibrato) # addiu $a1, $a1, 0x186c
...
/* B64FC0 800EDE20 3C088013 */  lui   $t0, %hi(sLastOcarinaRawPitch) # $t0, 0x8013
/* B64FC4 800EDE24 25081870 */  addiu $t0, %lo(sLastOcarinaRawPitch) # addiu $t0, $t0, 0x1870
/* B64FC8 800EDE28 810F0000 */  lb    $t7, ($t0)
/* B64FCC 800EDE2C 000EC0C0 */  sll   $t8, $t6, 3
/* B64FD0 800EDE30 0098C821 */  addu  $t9, $a0, $t8
/* B64FD4 800EDE34 3C098013 */  lui   $t1, %hi(sLastOcarinaBtnIdx) # $t1, 0x8013
/* B64FD8 800EDE38 A32F0006 */  sb    $t7, 6($t9)
/* B64FDC 800EDE3C 25291874 */  addiu $t1, %lo(sLastOcarinaBtnIdx) # addiu $t1, $t1, 0x1874
...
/* B65004 800EDE64 3C198013 */  lui   $t9, %hi(sCurOcarinaVolume) # $t9, 0x8013
/* B65008 800EDE68 3C188013 */  lui   $t8, %hi(sCurOcarinaVibrato) # $t8, 0x8013
/* B6500C 800EDE6C A04F0000 */  sb    $t7, ($v0)
/* B65010 800EDE70 83390F30 */  lb    $t9, %lo(sCurOcarinaVolume)($t9)
/* B65014 800EDE74 3C0E8013 */  lui   $t6, %hi(sCurOcarinaRawPitch) # $t6, 0x8013
/* B65018 800EDE78 3C0F8013 */  lui   $t7, %hi(sCurOcarinaBtnIdx) # $t7, 0x8013
/* B6501C 800EDE7C A0790000 */  sb    $t9, ($v1)
/* B65020 800EDE80 83180F34 */  lb    $t8, %lo(sCurOcarinaVibrato)($t8)
/* B65024 800EDE84 91B90000 */  lbu   $t9, ($t5)
/* B65028 800EDE88 A0B80000 */  sb    $t8, ($a1)
/* B6502C 800EDE8C 81CE0F2C */  lb    $t6, %lo(sCurOcarinaRawPitch)($t6)
...
/* B650C4 800EDF24 3C188017 */  lui   $t8, %hi(sRecordSongLen) # $t8, 0x8017
/* B650C8 800EDF28 5721008D */  bnel  $t9, $at, .L800EE160
/* B650CC 800EDF2C A3E00000 */   sb    $zero, ($ra)
/* B650D0 800EDF30 9318BA2E */  lbu   $t8, %lo(sRecordSongLen)($t8)
/* B650D4 800EDF34 3C038013 */  lui   $v1, %hi(sOcarinaTeachSongs) # $v1, 0x8013
/* B650D8 800EDF38 24630F80 */  addiu $v1, %lo(sOcarinaTeachSongs) # addiu $v1, $v1, 0xf80
...
/* B6514C 800EDFAC 0C03B2DF */  jal   AudioOcarina_ConvertTeachToDetectable
/* B65150 800EDFB0 A7A9001E */   sh    $t1, 0x1e($sp)
/* B65154 800EDFB4 3C0D8013 */  lui   $t5, %hi(sRecordSongPos) # $t5, 0x8013
/* B65158 800EDFB8 3C1F8013 */  lui   $ra, %hi(sOcarinaRecordMode) # $ra, 0x8013
/* B6515C 800EDFBC 3C078013 */  lui   $a3, %hi(sOcarinaDetectableSongs) # $a3, 0x8013
/* B65160 800EDFC0 27FF1858 */  addiu $ra, %lo(sOcarinaRecordMode) # addiu $ra, $ra, 0x1858
/* B65164 800EDFC4 25AD185C */  addiu $t5, %lo(sRecordSongPos) # addiu $t5, $t5, 0x185c
/* B65168 800EDFC8 97A9001E */  lhu   $t1, 0x1e($sp)
/* B6516C 800EDFCC 24E71C00 */  addiu $a3, %lo(sOcarinaDetectableSongs) # addiu $a3, $a3, 0x1c00
...
/* B65210 800EE070 3C038013 */  lui   $v1, %hi(sOcarinaTeachSongs) # $v1, 0x8013
/* B65214 800EE074 24630F80 */  addiu $v1, %lo(sOcarinaTeachSongs) # addiu $v1, $v1, 0xf80
...
/* B65288 800EE0E8 3C038013 */   lui   $v1, %hi(sOcarinaTeachSongs) # $v1, 0x8013
/* B6528C 800EE0EC 240200FF */  li    $v0, 255
/* B65290 800EE0F0 24630F80 */  addiu $v1, %lo(sOcarinaTeachSongs) # addiu $v1, $v1, 0xf80
...
/* B652AC 800EE10C 3C038013 */   lui   $v1, %hi(sOcarinaTeachSongs) # $v1, 0x8013
/* B652B0 800EE110 24630F80 */  addiu $v1, %lo(sOcarinaTeachSongs) # addiu $v1, $v1, 0xf80
.L800EE114:
