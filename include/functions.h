...
// ? func_800ECA00(?);
// ? AudioOcarina_NormalizePitch(?);
// ? func_800ECAF0(?);
// ? AudioOcarina_MapNoteValue(?);
// ? AudioOcarina_ConvertTeachToDetectable(?);
// ? func_800ECC04(?);
// ? func_800ECDBC(?);
// ? func_800ECDF8(?);
// ? func_800ED200(?);
...
// ? AudioOcarina_SetSong(?);
// ? AudioOcarina_PlaybackSong(?);
// ? AudioOcarina_RecordStep(?);
// ? AudioOcarina_SetRecordMode(?);
// ? func_800EE29C(?);
// ? func_800EE2D4(?);
// ? func_800EE318(?);
// ? func_800EE3C8(?);
...
void Audio_SetSomeBit(u8);
void Audio_ClearSomeBit(u8);
